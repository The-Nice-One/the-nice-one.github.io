...
A simple discord bot bringing a point system to your server. [Read more.](/playground/reputation-bot)
...
A simple Python text based game in which you buy water... nothing more. [Read more.](/playground/console-game)
...
A 2D tile-based shooter game made with Rust and [Emerald](https://crates.io/crates/emerald). [Read more.](/playground/gmtk2022)

**\emoji{lua} Loop Blaster:** [View on Github](https://github.com/The-Nice-One/PlaygroundProjects/tree/main/Games/LoopBlaster)\
A 2D shooter game with a unique mechanic, built with Picotron. [Read more.](/playground/loop-blaster)

**\emoji{godot} Maze Game:** [View on Github](https://github.com/The-Nice-One/PlaygroundProjects/tree/main/Games/MazeGame)\
A maze game with multiple control methods created in the Godot game engine. [Read more.](/playground/maze-game)
...
A simple Rust Terminal User Interface (TUI) library with an expansive component system and complete control over logic and style. [Read more.](/playground/retro-engine)
...
A javascript prototype for my programming language. [Read more.](/playground/js-repl-env)
...
A simulation of a physical safe-box built during my High School 10th grade, using the Godot Game Engine. [Read more.](/playground/safebox-simulation)
